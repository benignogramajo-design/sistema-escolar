// Importaciones de las páginas principales (menús)
...
// Importaciones de los submenús y páginas finales
...
import PersonalInstitucional from "./pages.css/submenu/PersonalInstitucional";
import PersonalPorDia from "./pages.css/submenu/PersonalPorDia";
import PlanillasATACALAR from "./pages.css/submenu/PlanillasATACALAR";
...
import PlanillasCicloBasico from "./pages.css/submenu/PlanillasCicloBasico";
...
import PlanillasRiesgoPedagogico from "./pages.css/submenu/PlanillasRiesgoPedagogico";
...
import PreceptoriaCompendiosBlanco from "./pages.css/submenu/PreceptoriaCompendiosBlanco";
import PreceptoriaCompendiosNotas from "./pages.css/submenu/PreceptoriaCompendiosNotas";
...
import RegistroAlumnosFicha from "./pages.css/submenu/RegistroAlumnosFicha";
...
export const navigationMap = {
  // --- PÁGINAS PRINCIPALES (MENÚS) ---
  // Estas páginas contienen botones y necesitan la función `navigate`
  ...
  SalidaEducativa: { component: SalidaEducativa, needsNavigate: true }, // Este es el menú para "Ver Salidas"
  ...
  // --- PÁGINAS FINALES (NO NECESITAN `navigate`) ---
  // Estas son las páginas de destino que muestran contenido o formularios
  ...
  RegistroDocentesConstanciasPermanencia: { component: RegistroDocentesConstanciasPermanencia },
  RegistroDocentesConstanciaTrabajo: { component: RegistroDocentesConstanciaTrabajo },
  RegistroAlumnosFicha: { component: RegistroAlumnosFicha },
  ...
  PlanillasCicloBasico: { component: PlanillasCicloBasico },
  ...
  PlanillasATACALAR: { component: PlanillasATACALAR },
  ...
  PreceptoriaCompendiosBlanco: { component: PreceptoriaCompendiosBlanco },
  PreceptoriaCompendiosNotas: { component: PreceptoriaCompendiosNotas },
