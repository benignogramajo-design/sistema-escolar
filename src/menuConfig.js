    ...
    subModules: [
      {
        ...
        subItems: [
          ...
          { name: "DATOS DE LEGAGO", action: "DocentesDatosLegajo" },
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: "RIEGO PEDAGÓGICO", action: "PlanillasRiegoPedagogico" },
          ...
          { name: "BACHILLER EN INFORMATIVA", action: "PlanillasBachillerInformatica" },
