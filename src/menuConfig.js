...
export const menuConfig = [
  ...
  },
  {
    ...
    subModules: [
      ...
      },
      {
        ...
        subItems: [
          { name: "FICHA DEL ALUMNO", action: "RegistroAlumnosFicha" },
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: "RIESGO PEDAGÓGICO", action: "PlanillasRiesgoPedagogico" },
          { name: "ESTADÍSTICA GENERAL", action: "PlanillasEstadisticaGeneral" },
          { name: "CICLO BÁSICO", action: "PlanillasCicloBasico" },
          ...
          { name: "ATACALAR", action: "PlanillasATACALAR" },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "COMPENDIOS EN BLANCO", action: "PreceptoriaCompendiosBlanco" },
      { name: "COMPENDIOS CON NOTAS", action: "PreceptoriaCompendiosNotas" },
